                    ...
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link class="flex" href="/">
                                ...
                                <span class="mt-2 font-semibold ml-3 text-indigo-500">Share Karen</span>
                            </inertia-link>
                        </div>

                        <!-- Navigation Links -->
                        <div v-if="!$page.user" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <a :href="route('login')" class="inline-flex bg-indigo-500 my-3 px-6 items-center border-transparent text-sm font-medium leading-5 text-white rounded-md transition duration-150 ease-in-out">
                                Login
                            </a>
                        ...
                        <div v-else class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                           ...
                           <jet-nav-link :href="route('album.index')" :active="route().current('album.index')">
                                My Album
                            </jet-nav-link>
                        </div>
                    </div>
